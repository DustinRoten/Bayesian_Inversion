...
imin_lat <- which.min(abs(nc_lat - min(sub_lat)))[1] #Southern bound
imax_lat <- which.min(abs(nc_lat - max(sub_lat)))[1] #Northern bound
imin_lon <- which.min(abs(nc_lon - min(sub_lon)))[1] #Western bound
imax_lon <- which.min(abs(nc_lon - max(sub_lon)))[1] #Eastern bound
